...
```kotlin
fun main() {
    println("My name is oujiachun")
    println("My student ID is 2025003007")
...
```kotlin
fun main() {
    println("Student [2025003007] says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is [oujiachun]")
}
```
...
```kotlin
fun main() {
    println("ID: [2025003007]") 
    println("Name: [oujiachun]") 
...
```kotlin
fun main() {
    val name: String = "oujiachun"
    val stucedentID = 2025003007
...
fun main() {
    ...
    println(printinfo("[oujiachun]", B))   
}

fun printinfo(name: String = "2025003007", age: Int): String {return "Hello,$name!Your age is $age."
}
```
...
```kotlin
fun main() {
    printOujiachunWeather("Ankara", 27, 31, 82)
    printOujiachunWeather("Tokyo", 32, 36, 10)
    printOujiachunWeather("Cape Town", 59, 64, 2)
    printOujiachunWeather("Guatemala City", 50, 55, 7)
}
fun printOujiachunWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
